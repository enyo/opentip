...
/*!
    ...
    * license MIT
    */
;!function(name,definition){typeof module!="undefined"?module.exports=definition():typeof define=="function"&&define.amd?define(name,definition):this[name]=definition()}("reqwest",function(){function handleReadyState(o,success,error){return function(){o&&o[readyState]==4&&(twoHundo.test(o.status)?success(o):error(o))}}function setHeaders(http,o){var headers=o.headers||{},h;headers.Accept=headers.Accept||defaultHeaders.accept[o.type]||defaultHeaders.accept["*"];!o.crossOrigin&&!headers[requestedWith]&&(headers[requestedWith]=defaultHeaders.requestedWith);headers[contentType]||(headers[contentType]=o.contentType||defaultHeaders.contentType);for(h in headers)headers.hasOwnProperty(h)&&http.setRequestHeader(h,headers[h])}function generalCallback(data){lastValue=data}function urlappend(url,s){return url+(/\?/.test(url)?"&":"?")+s}function handleJsonp(o,fn,err,url){var reqId=uniqid++,cbkey=o.jsonpCallback||"callback",cbval=o.jsonpCallbackName||"reqwest_"+reqId,cbreg=new RegExp("((^|\\?|&)"+cbkey+")=([^&]+)"),match=url.match(cbreg),script=doc.createElement("script"),loaded=0;match?match[3]==="?"?url=url.replace(cbreg,"$1="+cbval):cbval=match[3]:url=urlappend(url,cbkey+"="+cbval);win[cbval]=generalCallback;script.type="text/javascript";script.src=url;script.async=!0;if(typeof script.onreadystatechange!="undefined"){script.event="onclick";script.htmlFor=script.id="_reqwest_"+reqId}script.onload=script.onreadystatechange=function(){if(script[readyState]&&script[readyState]!=="complete"&&script[readyState]!=="loaded"||loaded)return!1;script.onload=script.onreadystatechange=null;script.onclick&&script.onclick();o.success&&o.success(lastValue);lastValue=undefined;head.removeChild(script);loaded=1};head.appendChild(script)}function getRequest(o,fn,err){var method=(o.method||"GET").toUpperCase(),url=typeof o=="string"?o:o.url,data=o.processData!==!1&&o.data&&typeof o.data!="string"?reqwest.toQueryString(o.data):o.data||null,http;if((o.type=="jsonp"||method=="GET")&&data){url=urlappend(url,data);data=null}if(o.type=="jsonp")return handleJsonp(o,fn,err,url);http=xhr();http.open(method,url,!0);setHeaders(http,o);http.onreadystatechange=handleReadyState(http,fn,err);o.before&&o.before(http);http.send(data);return http}function Reqwest(o,fn){this.o=o;this.fn=fn;init.apply(this,arguments)}function setType(url){var m=url.match(/\.(json|jsonp|html|xml)(\?|$)/);return m?m[1]:"js"}function init(o,fn){function complete(resp){o.timeout&&clearTimeout(self.timeout);self.timeout=null;o.complete&&o.complete(resp)}function success(resp){var r=resp.responseText;if(r)switch(type){case"json":try{resp=win.JSON?win.JSON.parse(r):eval("("+r+")")}catch(err){return error(resp,"Could not parse JSON in response",err)}break;case"js":resp=eval(r);break;case"html":resp=r}fn(resp);o.success&&o.success(resp);complete(resp)}function error(resp,msg,t){o.error&&o.error(resp,msg,t);complete(resp)}this.url=typeof o=="string"?o:o.url;this.timeout=null;var type=o.type||setType(this.url),self=this;fn=fn||function(){};o.timeout&&(this.timeout=setTimeout(function(){self.abort()},o.timeout));this.request=getRequest(o,success,error)}function reqwest(o,fn){return new Reqwest(o,fn)}function normalize(s){return s?s.replace(/\r?\n/g,"\r\n"):""}function serial(el,cb){var n=el.name,t=el.tagName.toLowerCase(),optCb=function(o){o&&!o.disabled&&cb(n,normalize(o.attributes.value&&o.attributes.value.specified?o.value:o.text))};if(el.disabled||!n)return;switch(t){case"input":if(!/reset|button|image|file/i.test(el.type)){var ch=/checkbox/i.test(el.type),ra=/radio/i.test(el.type),val=el.value;(!ch&&!ra||el.checked)&&cb(n,normalize(ch&&val===""?"on":val))}break;case"textarea":cb(n,normalize(el.value));break;case"select":if(el.type.toLowerCase()==="select-one")optCb(el.selectedIndex>=0?el.options[el.selectedIndex]:null);else for(var i=0;el.length&&i<el.length;i++)el.options[i].selected&&optCb(el.options[i])}}function eachFormElement(){var cb=this,e,i,j,serializeSubtags=function(e,tags){for(var i=0;i<tags.length;i++){var fa=e[byTag](tags[i]);for(j=0;j<fa.length;j++)serial(fa[j],cb)}};for(i=0;i<arguments.length;i++){e=arguments[i];/input|select|textarea/i.test(e.tagName)&&serial(e,cb);serializeSubtags(e,["input","select","textarea"])}}function serializeQueryString(){return reqwest.toQueryString(reqwest.serializeArray.apply(null,arguments))}function serializeHash(){var hash={};eachFormElement.apply(function(name,value){if(name in hash){hash[name]&&!isArray(hash[name])&&(hash[name]=[hash[name]]);hash[name].push(value)}else hash[name]=value},arguments);return hash}var win=window,doc=document,twoHundo=/^20\d$/,byTag="getElementsByTagName",readyState="readyState",contentType="Content-Type",requestedWith="X-Requested-With",head=doc[byTag]("head")[0],uniqid=0,lastValue,xmlHttpRequest="XMLHttpRequest",isArray=typeof Array.isArray=="function"?Array.isArray:function(a){return a instanceof Array},defaultHeaders={contentType:"application/x-www-form-urlencoded",accept:{"*":"text/javascript, text/html, application/xml, text/xml, */*",xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript",js:"application/javascript, text/javascript"},requestedWith:xmlHttpRequest},xhr=win[xmlHttpRequest]?function(){return new XMLHttpRequest}:function(){return new ActiveXObject("Microsoft.XMLHTTP")};Reqwest.prototype={abort:function(){this.request.abort()},retry:function(){init.call(this,this.o,this.fn)}};reqwest.serializeArray=function(){var arr=[];eachFormElement.apply(function(name,value){arr.push({name:name,value:value})},arguments);return arr};reqwest.serialize=function(){if(arguments.length===0)return"";var opt,fn,args=Array.prototype.slice.call(arguments,0);opt=args.pop();opt&&opt.nodeType&&args.push(opt)&&(opt=null);opt&&(opt=opt.type);opt=="map"?fn=serializeHash:opt=="array"?fn=reqwest.serializeArray:fn=serializeQueryString;return fn.apply(null,args)};reqwest.toQueryString=function(o){var qs="",i,enc=encodeURIComponent,push=function(k,v){qs+=enc(k)+"="+enc(v)+"&"};if(isArray(o))for(i=0;o&&i<o.length;i++)push(o[i].name,o[i].value);else for(var k in o){if(!Object.hasOwnProperty.call(o,k))continue;var v=o[k];if(isArray(v))for(i=0;i<v.length;i++)push(k,v[i]);else push(k,o[k])}return qs.replace(/&$/,"").replace(/%20/g,"+")};reqwest.compat=function(o,fn){if(o){o.type&&(o.method=o.type)&&delete o.type;o.dataType&&(o.type=o.dataType);o.jsonpCallback&&(o.jsonpCallbackName=o.jsonpCallback)&&delete o.jsonpCallback;o.jsonp&&(o.jsonpCallback=o.jsonp)}return new Reqwest(o,fn)};return reqwest});provide("reqwest",module.exports);!function($){var r=require("reqwest"),integrate=function(method){return function(){var args=Array.prototype.slice.call(arguments,0),i=this&&this.length||0;while(i--)args.unshift(this[i]);return r[method].apply(null,args)}},s=integrate("serialize"),sa=integrate("serializeArray");$.ender({ajax:r,serialize:r.serialize,serializeArray:r.serializeArray,toQueryString:r.toQueryString});$.ender({serialize:s,serializeArray:sa},!0)}(ender)})();(function(){var module={exports:{}},exports=module.exports,Opentip,firstAdapter,i,position,vendors,_i,_len,_ref,__slice=[].slice,__indexOf=[].indexOf||function(item){for(var i=0,l=this.length;i<l;i++)if(i in this&&this[i]===item)return i;return-1},__hasProp={}.hasOwnProperty;Opentip=function(){function Opentip(element,content,title,options){var elementsOpentips,hideTrigger,optionSources,prop,styleOptions,_i,_len,_ref,_ref1,_this=this;this.id=++Opentip.lastId;this.debug("Creating Opentip.");this.adapter=Opentip.adapter;elementsOpentips=this.adapter.data(element,"opentips")||[];elementsOpentips.push(this);this.adapter.data(element,"opentips",elementsOpentips);this.triggerElement=this.adapter.wrap(element);if(this.triggerElement.length>1)throw new Error("You can't call Opentip on multiple elements.");if(this.triggerElement.length<1)throw new Error("Invalid element.");this.loaded=!1;this.loading=!1;this.visible=!1;this.waitingToShow=!1;this.waitingToHide=!1;this.currentPosition={left:0,top:0};this.dimensions={width:100,height:50};this.content="";this.redraw=!0;this.currentObservers={showing:!1,visible:!1,hiding:!1,hidden:!1};options=this.adapter.clone(options);if(typeof content=="object"){options=content;content=title=void 0}else if(typeof title=="object"){options=title;title=void 0}title!=null&&(options.title=title);content!=null&&this.setContent(content);options.style||(options.style=Opentip.defaultStyle);styleOptions=this.adapter.extend({},Opentip.styles.standard);optionSources=[];optionSources.push(Opentip.styles.standard);options.style!=="standard"&&optionSources.push(Opentip.styles[options.style]);optionSources.push(options);options=(_ref=this.adapter).extend.apply(_ref,[{}].concat(__slice.call(optionSources)));options.hideTriggers=function(){var _i,_len,_ref1,_results;_ref1=options.hideTriggers;_results=[];for(_i=0,_len=_ref1.length;_i<_len;_i++){hideTrigger=_ref1[_i];_results.push(hideTrigger)}return _results}();options.hideTrigger&&options.hideTriggers.push(options.hideTrigger);_ref1=["tipJoint","targetJoint","stem"];for(_i=0,_len=_ref1.length;_i<_len;_i++){prop=_ref1[_i];options[prop]&&typeof options[prop]=="string"&&(options[prop]=new Opentip.Joint(options[prop]))}options.ajax&&(options.ajax===!0||!options.ajax)&&(this.adapter.tagName(this.triggerElement)==="A"?options.ajax=this.adapter.attr(this.triggerElement,"href"):options.ajax=!1);options.showOn==="click"&&this.adapter.tagName(this.triggerElement)==="A"&&this.adapter.observe(this.triggerElement,"click",function(e){e.preventDefault();e.stopPropagation();return e.stopped=!0});options.target&&(options.fixed=!0);options.stem===!0&&(options.stem=new Opentip.Joint(options.tipJoint));options.target===!0?options.target=this.triggerElement:options.target&&(options.target=this.adapter.wrap(options.target));this.currentStem=options.stem;options.delay==null&&(options.delay=options.showOn==="mouseover"?.2:0);options.targetJoint==null&&(options.targetJoint=(new Opentip.Joint(options.tipJoint)).flip());this.showTriggersWhenHidden=[];this.showTriggersWhenVisible=[];this.hideTriggers=[];options.showOn&&options.showOn!=="creation"&&this.showTriggersWhenHidden.push({element:this.triggerElement,event:options.showOn});this.options=options;this.adapter.domReady(function(){return _this._init()})}Opentip.prototype.STICKS_OUT_TOP=1;Opentip.prototype.STICKS_OUT_BOTTOM=2;Opentip.prototype.STICKS_OUT_LEFT=1;Opentip.prototype.STICKS_OUT_RIGHT=2;Opentip.prototype["class"]={container:"opentip-container",opentip:"opentip",content:"content",loadingIndicator:"loading-indicator",close:"close",goingToHide:"going-to-hide",hidden:"hidden",hiding:"hiding",goingToShow:"going-to-show",showing:"showing",visible:"visible",loading:"loading",ajaxError:"ajax-error",fixed:"fixed",showEffectPrefix:"show-effect-",hideEffectPrefix:"hide-effect-",stylePrefix:"style-"};Opentip.prototype._init=function(){var hideOn,hideTrigger,hideTriggerElement,i,methodToBind,_i,_j,_len,_len1,_ref,_ref1,_this=this;this._buildContainer();_ref=this.options.hideTriggers;for(i=_i=0,_len=_ref.length;_i<_len;i=++_i){hideTrigger=_ref[i];hideTriggerElement=null;hideOn=this.options.hideOn instanceof Array?this.options.hideOn[i]:this.options.hideOn;if(typeof hideTrigger=="string")switch(hideTrigger){case"trigger":hideOn=hideOn||"mouseout";hideTriggerElement=this.triggerElement;break;case"tip":hideOn=hideOn||"mouseover";hideTriggerElement=this.container;break;case"target":hideOn=hideOn||"mouseover";hideTriggerElement=this.options.target;break;case"closeButton":break;default:throw new Error("Unknown hide trigger: "+hideTrigger+".")}else{hideOn=hideOn||"mouseover";hideTriggerElement=this.adapter.wrap(hideTrigger)}if(hideTriggerElement){this.hideTriggers.push({element:hideTriggerElement,event:hideOn});hideOn==="mouseout"&&this.showTriggersWhenVisible.push({element:hideTriggerElement,event:"mouseover"})}}this.bound={};_ref1=["prepareToShow","prepareToHide","show","hide","reposition"];for(_j=0,_len1=_ref1.length;_j<_len1;_j++){methodToBind=_ref1[_j];this.bound[methodToBind]=function(methodToBind){return function(){return _this[methodToBind].apply(_this,arguments)}}(methodToBind)}this.activate();if(this.options.showOn==="creation")return this.prepareToShow()};Opentip.prototype._buildContainer=function(){this.container=this.adapter.create('<div id="opentip-'+this.id+'" class="'+this["class"].container+" "+this["class"].hidden+" "+this["class"].stylePrefix+this.options.className+'"></div>');this.adapter.css(this.container,{position:"absolute"});this.options.ajax&&this.adapter.addClass(this.container,this["class"].loading);this.options.fixed&&this.adapter.addClass(this.container,this["class"].fixed);this.options.showEffect&&this.adapter.addClass(this.container,""+this["class"].showEffectPrefix+this.options.showEffect);if(this.options.hideEffect)return this.adapter.addClass(this.container,""+this["class"].hideEffectPrefix+this.options.hideEffect)};Opentip.prototype._buildElements=function(){var headerElement,titleElement;this.tooltipElement=this.adapter.create('<div class="'+this["class"].opentip+'"><header></header><div class="'+this["class"].content+'"></div></div>');this.backgroundCanvas=this.adapter.create('<canvas style="position: absolute;"></canvas>');headerElement=this.adapter.find(this.tooltipElement,"header");if(this.options.title){titleElement=this.adapter.create("<h1></h1>");this.adapter.update(titleElement,this.options.title,this.options.escapeTitle);this.adapter.append(headerElement,titleElement)}this.options.ajax&&this.adapter.append(this.tooltipElement,this.adapter.create('<div class="'+this["class"].loadingIndicator+'"><span>Loading...</span></div>'));if(__indexOf.call(this.options.hideTriggers,"closeButton")>=0){this.closeButtonElement=this.adapter.create('<a href="javascript:undefined;" class="'+this["class"].close+'"><span>Close</span></a>');this.adapter.append(headerElement,this.closeButtonElement)}this.adapter.append(this.container,this.backgroundCanvas);this.adapter.append(this.container,this.tooltipElement);return this.adapter.append(document.body,this.container)};Opentip.prototype.setContent=function(content){this.content=content;if(this.visible)return this._updateElementContent()};Opentip.prototype._updateElementContent=function(){var contentDiv;contentDiv=this.adapter.find(this.container,".content");if(contentDiv!=null){if(typeof this.content=="function"){this.debug("Executing content function.");this.content=this.content(this)}this.adapter.update(contentDiv,this.content,this.options.escapeContent)}this._storeAndLockDimensions();return this.reposition()};Opentip.prototype._storeAndLockDimensions=function(){var prevDimension;prevDimension=this.dimensions;this.adapter.css(this.container,{width:"auto",left:"0px",top:"0px"});this.dimensions=this.adapter.dimensions(this.container);this.dimensions.width+=1;this.adapter.css(this.container,{width:""+this.dimensions.width+"px",top:""+this.currentPosition.top+"px",left:""+this.currentPosition.left+"px"});if(!this._dimensionsEqual(this.dimensions,prevDimension)){this.redraw=!0;return this._draw()}};Opentip.prototype.activate=function(){return this._setupObservers("-showing","-visible","hidden","hiding")};Opentip.prototype.deactivate=function(){this.debug("Deactivating tooltip.");return this.hide()};Opentip.prototype._setupObservers=function(){var observeOrStop,removeObserver,state,states,trigger,_i,_j,_k,_l,_len,_len1,_len2,_len3,_ref,_ref1,_ref2,_this=this;states=1<=arguments.length?__slice.call(arguments,0):[];for(_i=0,_len=states.length;_i<_len;_i++){state=states[_i];removeObserver=!1;if(state.charAt(0)==="-"){removeObserver=!0;state=state.substr(1)}if(this.currentObservers[state]===!removeObserver)continue;this.currentObservers[state]=!removeObserver;observeOrStop=function(){var args,_ref,_ref1;args=1<=arguments.length?__slice.call(arguments,0):[];return removeObserver?(_ref=_this.adapter).stopObserving.apply(_ref,args):(_ref1=_this.adapter).observe.apply(_ref1,args)};switch(state){case"showing":_ref=this.hideTriggers;for(_j=0,_len1=_ref.length;_j<_len1;_j++){trigger=_ref[_j];observeOrStop(trigger.element,trigger.event,this.bound.prepareToHide)}observeOrStop(document.onresize!=null?document:window,"resize",this.bound.reposition);observeOrStop(window,"scroll",this.bound.reposition);break;case"visible":_ref1=this.showTriggersWhenVisible;for(_k=0,_len2=_ref1.length;_k<_len2;_k++){trigger=_ref1[_k];observeOrStop(trigger.element,trigger.event,this.bound.prepareToShow)}break;case"hiding":_ref2=this.showTriggersWhenHidden;for(_l=0,_len3=_ref2.length;_l<_len3;_l++){trigger=_ref2[_l];observeOrStop(trigger.element,trigger.event,this.bound.prepareToShow)}break;case"hidden":break;default:throw new Error("Unknown state: "+state)}}return null};Opentip.prototype.prepareToShow=function(){this._abortHiding();if(this.visible)return;this.debug("Showing in "+this.options.delay+"s.");this.options.group&&Opentip._abortShowingGroup(this.options.group);this.preparingToShow=!0;this._setupObservers("-hidden","-hiding","showing");this._followMousePosition();this.reposition();return this._showTimeoutId=this.setTimeout(this.bound.show,this.options.delay||0)};Opentip.prototype.show=function(){var _this=this;this._clearTimeouts();if(this.visible)return;if(!this._triggerElementExists())return this.deactivate();this.debug("Showing now.");this.options.group&&Opentip._hideGroup(this.options.group);this.visible=!0;this.preparingToShow=!1;this.tooltipElement==null&&this._buildElements();this._updateElementContent();this.options.ajax&&(!this.loaded||!this.options.ajaxCache)&&this._loadAjax();this._searchAndActivateCloseButtons();this._startEnsureTriggerElement();this.adapter.css(this.container,{zIndex:Opentip.lastZIndex++});this._setupObservers("-hidden","-hiding","showing","visible");this.reposition();this.adapter.removeClass(this.container,this["class"].hiding);this.adapter.removeClass(this.container,this["class"].hidden);this.adapter.addClass(this.container,this["class"].goingToShow);this.setCss3Style(this.container,{transitionDuration:"0s"});this.defer(function(){var delay;_this.adapter.removeClass(_this.container,_this["class"].goingToShow);_this.adapter.addClass(_this.container,_this["class"].showing);delay=0;_this.options.showEffect&&_this.options.showEffectDuration&&(delay=_this.options.showEffectDuration);_this.setCss3Style(_this.container,{transitionDuration:""+delay+"s"});_this._visibilityStateTimeoutId=_this.setTimeout(function(){_this.adapter.removeClass(_this.container,_this["class"].showing);return _this.adapter.addClass(_this.container,_this["class"].visible)},delay);return _this._activateFirstInput()});return this._draw()};Opentip.prototype._abortShowing=function(){if(this.preparingToShow){this.debug("Aborting showing.");this._clearTimeouts();this._stopFollowingMousePosition();this.preparingToShow=!1;return this._setupObservers("-showing","-visible","hiding","hidden")}};Opentip.prototype.prepareToHide=function(){this._abortShowing();if(!this.visible)return;this.debug("Hiding in "+this.options.hideDelay+"s");this.preparingToHide=!0;this._setupObservers("-showing","-visible","-hidden","hiding");return this._hideTimeoutId=this.setTimeout(this.bound.hide,this.options.hideDelay)};Opentip.prototype.hide=function(){var _this=this;this._clearTimeouts();if(!this.visible)return;this.debug("Hiding!");this.visible=!1;this.preparingToHide=!1;this._stopEnsureTriggerElement();this._setupObservers("-showing","-visible","hiding","hidden");this.options.fixed||this._stopFollowingMousePosition();this.adapter.removeClass(this.container,this["class"].visible);this.adapter.removeClass(this.container,this["class"].showing);this.adapter.addClass(this.container,this["class"].goingToHide);this.setCss3Style(this.container,{transitionDuration:"0s"});return this.defer(function(){var hideDelay;_this.adapter.removeClass(_this.container,_this["class"].goingToHide);_this.adapter.addClass(_this.container,_this["class"].hiding);hideDelay=0;_this.options.hideEffect&&_this.options.hideEffectDuration&&(hideDelay=_this.options.hideEffectDuration);_this.setCss3Style(_this.container,{transitionDuration:""+hideDelay+"s"});return _this._visibilityStateTimeoutId=_this.setTimeout(function(){_this.adapter.removeClass(_this.container,_this["class"].hiding);_this.adapter.addClass(_this.container,_this["class"].hidden);return _this.setCss3Style(_this.container,{transitionDuration:"0s"})},hideDelay)})};Opentip.prototype._abortHiding=function(){if(this.preparingToHide){this.debug("Aborting hiding.");this._clearTimeouts();this.preparingToHide=!1;return this._setupObservers("-hiding","showing","visible")}};Opentip.prototype.reposition=function(e){var position,stem,_ref,_this=this;e==null&&(e=this.lastEvent);position=this.getPosition(e);if(position==null)return;stem=this.options.stem;this.options.containInViewport&&(_ref=this._ensureViewportContainment(e,position),position=_ref.position,stem=_ref.stem);if(this._positionsEqual(position,this.currentPosition))return;!!this.options.stem&&!stem.eql(this.currentStem)&&(this.redraw=!0);this.currentPosition=position;this.currentStem=stem;this._draw();this.adapter.css(this.container,{left:""+position.left+"px",top:""+position.top+"px"});return this.defer(function(){var rawContainer,redrawFix;rawContainer=_this.adapter.unwrap(_this.container);rawContainer.style.visibility="hidden";redrawFix=rawContainer.offsetHeight;return rawContainer.style.visibility="visible"})};Opentip.prototype.getPosition=function(e,tipJoint,targetJoint,stem){var additionalHorizontal,additionalVertical,mousePosition,offsetDistance,position,stemLength,targetDimensions,targetPosition,unwrappedTarget,_ref;tipJoint==null&&(tipJoint=this.options.tipJoint);targetJoint==null&&(targetJoint=this.options.targetJoint);position={};if(this.options.target){targetPosition=this.adapter.offset(this.options.target);targetDimensions=this.adapter.dimensions(this.options.target);position=targetPosition;if(targetJoint.right){unwrappedTarget=this.adapter.unwrap(this.options.target);unwrappedTarget.getBoundingClientRect!=null?position.left=unwrappedTarget.getBoundingClientRect().right+((_ref=window.pageXOffset)!=null?_ref:document.body.scrollLeft):position.left+=targetDimensions.width}else targetJoint.center&&(position.left+=Math.round(targetDimensions.width/2));targetJoint.bottom?position.top+=targetDimensions.height:targetJoint.middle&&(position.top+=Math.round(targetDimensions.height/2));if(this.options.borderWidth){this.options.tipJoint.left&&(position.left+=this.options.borderWidth);this.options.tipJoint.right&&(position.left-=this.options.borderWidth);this.options.tipJoint.top?position.top+=this.options.borderWidth:this.options.tipJoint.bottom&&(position.top-=this.options.borderWidth)}}else{e!=null&&(this.lastEvent=e);mousePosition=this.adapter.mousePosition(e);if(mousePosition==null)return;position={top:mousePosition.y,left:mousePosition.x}}if(this.options.autoOffset){stemLength=this.options.stem?this.options.stemLength:0;offsetDistance=stemLength&&this.options.fixed?2:10;additionalHorizontal=tipJoint.middle&&!this.options.fixed?15:0;additionalVertical=tipJoint.center&&!this.options.fixed?15:0;tipJoint.right?position.left-=offsetDistance+additionalHorizontal:tipJoint.left&&(position.left+=offsetDistance+additionalHorizontal);tipJoint.bottom?position.top-=offsetDistance+additionalVertical:tipJoint.top&&(position.top+=offsetDistance+additionalVertical);if(stemLength){stem==null&&(stem=this.options.stem);stem.right?position.left-=stemLength:stem.left&&(position.left+=stemLength);stem.bottom?position.top-=stemLength:stem.top&&(position.top+=stemLength)}}position.left+=this.options.offset[0];position.top+=this.options.offset[1];tipJoint.right?position.left-=this.dimensions.width:tipJoint.center&&(position.left-=Math.round(this.dimensions.width/2));tipJoint.bottom?position.top-=this.dimensions.height:tipJoint.middle&&(position.top-=Math.round(this.dimensions.height/2));return position};Opentip.prototype._ensureViewportContainment=function(e,position){var needsRepositioning,newSticksOut,originals,revertedX,revertedY,scrollOffset,stem,sticksOut,targetJoint,tipJoint,viewportDimensions,viewportPosition;stem=this.options.stem;originals={position:position,stem:stem};if(!this.visible||!position)return originals;sticksOut=this._sticksOut(position);if(!sticksOut[0]&&!sticksOut[1])return originals;tipJoint=new Opentip.Joint(this.options.tipJoint);this.options.targetJoint&&(targetJoint=new Opentip.Joint(this.options.targetJoint));scrollOffset=this.adapter.scrollOffset();viewportDimensions=this.adapter.viewportDimensions();viewportPosition=[position.left-scrollOffset[0],position.top-scrollOffset[1]];needsRepositioning=!1;if(viewportDimensions.width>=this.dimensions.width&&sticksOut[0]){needsRepositioning=!0;switch(sticksOut[0]){case this.STICKS_OUT_LEFT:tipJoint.setHorizontal("left");this.options.targetJoint&&targetJoint.setHorizontal("right");break;case this.STICKS_OUT_RIGHT:tipJoint.setHorizontal("right");this.options.targetJoint&&targetJoint.setHorizontal("left")}}if(viewportDimensions.height>=this.dimensions.height&&sticksOut[1]){needsRepositioning=!0;switch(sticksOut[1]){case this.STICKS_OUT_TOP:tipJoint.setVertical("top");this.options.targetJoint&&targetJoint.setVertical("bottom");break;case this.STICKS_OUT_BOTTOM:tipJoint.setVertical("bottom");this.options.targetJoint&&targetJoint.setVertical("top")}}if(!needsRepositioning)return originals;this.options.stem&&(stem=tipJoint);position=this.getPosition(e,tipJoint,targetJoint,stem);newSticksOut=this._sticksOut(position);revertedX=!1;revertedY=!1;if(newSticksOut[0]&&newSticksOut[0]!==sticksOut[0]){revertedX=!0;tipJoint.setHorizontal(this.options.tipJoint.horizontal);this.options.targetJoint&&targetJoint.setHorizontal(this.options.targetJoint.horizontal)}if(newSticksOut[1]&&newSticksOut[1]!==sticksOut[1]){revertedY=!0;tipJoint.setVertical(this.options.tipJoint.vertical);this.options.targetJoint&&targetJoint.setVertical(this.options.targetJoint.vertical)}if(revertedX&&revertedY)return originals;if(revertedX||revertedY){this.options.stem&&(stem=tipJoint);position=this.getPosition(e,tipJoint,targetJoint,stem)}return{position:position,stem:stem}};Opentip.prototype._sticksOut=function(position){var positionOffset,scrollOffset,sticksOut,viewportDimensions;scrollOffset=this.adapter.scrollOffset();viewportDimensions=this.adapter.viewportDimensions();positionOffset=[position.left-scrollOffset[0],position.top-scrollOffset[1]];sticksOut=[!1,!1];positionOffset[0]<0?sticksOut[0]=this.STICKS_OUT_LEFT:positionOffset[0]+this.dimensions.width>viewportDimensions.width&&(sticksOut[0]=this.STICKS_OUT_RIGHT);positionOffset[1]<0?sticksOut[1]=this.STICKS_OUT_TOP:positionOffset[1]+this.dimensions.height>viewportDimensions.height&&(sticksOut[1]=this.STICKS_OUT_BOTTOM);return sticksOut};Opentip.prototype._draw=function(){var backgroundCanvas,bulge,canvasDimensions,canvasPosition,closeButton,closeButtonInner,closeButtonOuter,ctx,drawCorner,drawLine,hb,stemBase,stemLength,_ref,_ref1,_this=this;if(!this.backgroundCanvas||!this.redraw)return;this.debug("Drawing background.");this.redraw=!1;closeButtonInner=[0,0];closeButtonOuter=[0,0];if(__indexOf.call(this.options.hideTriggers,"closeButton")>=0){closeButton=new Opentip.Joint(((_ref=this.currentStem)!=null?_ref.toString():void 0)==="top right"?"top left":"top right");closeButtonInner=[this.options.closeButtonRadius+this.options.closeButtonOffset[0],this.options.closeButtonRadius+this.options.closeButtonOffset[1]];closeButtonOuter=[this.options.closeButtonRadius-this.options.closeButtonOffset[0],this.options.closeButtonRadius-this.options.closeButtonOffset[1]]}canvasDimensions=this.adapter.clone(this.dimensions);canvasPosition=[0,0];if(this.options.borderWidth){canvasDimensions.width+=this.options.borderWidth*2;canvasDimensions.height+=this.options.borderWidth*2;canvasPosition[0]-=this.options.borderWidth;canvasPosition[1]-=this.options.borderWidth}if(this.options.shadow){canvasDimensions.width+=this.options.shadowBlur*2;canvasDimensions.width+=Math.max(0,this.options.shadowOffset[0]-this.options.shadowBlur*2);canvasDimensions.height+=this.options.shadowBlur*2;canvasDimensions.height+=Math.max(0,this.options.shadowOffset[1]-this.options.shadowBlur*2);canvasPosition[0]-=Math.max(0,this.options.shadowBlur-this.options.shadowOffset[0]);canvasPosition[1]-=Math.max(0,this.options.shadowBlur-this.options.shadowOffset[1])}bulge={left:0,right:0,top:0,bottom:0};if(this.currentStem){this.currentStem.left?bulge.left=this.options.stemLength:this.currentStem.right&&(bulge.right=this.options.stemLength);this.currentStem.top?bulge.top=this.options.stemLength:this.currentStem.bottom&&(bulge.bottom=this.options.stemLength)}if(closeButton){closeButton.left?bulge.left=Math.max(bulge.left,closeButtonOuter[0]):closeButton.right&&(bulge.right=Math.max(bulge.right,closeButtonOuter[0]));closeButton.top?bulge.top=Math.max(bulge.top,closeButtonOuter[1]):closeButton.bottom&&(bulge.bottom=Math.max(bulge.bottom,closeButtonOuter[1]))}canvasDimensions.width+=bulge.left+bulge.right;canvasDimensions.height+=bulge.top+bulge.bottom;canvasPosition[0]-=bulge.left;canvasPosition[1]-=bulge.top;this.currentStem&&this.options.borderWidth&&(_ref1=this._getPathStemMeasures(this.options.stemBase,this.options.stemLength,this.options.borderWidth),stemLength=_ref1.stemLength,stemBase=_ref1.stemBase);backgroundCanvas=this.adapter.unwrap(this.backgroundCanvas);backgroundCanvas.width=canvasDimensions.width;backgroundCanvas.height=canvasDimensions.height;this.adapter.css(this.backgroundCanvas,{width:""+backgroundCanvas.width+"px",height:""+backgroundCanvas.height+"px",left:""+canvasPosition[0]+"px",top:""+canvasPosition[1]+"px"});ctx=backgroundCanvas.getContext("2d");ctx.clearRect(0,0,backgroundCanvas.width,backgroundCanvas.height);ctx.beginPath();ctx.fillStyle=this._getColor(ctx,this.dimensions,this.options.background,this.options.backgroundGradientHorizontal);ctx.lineJoin="miter";ctx.miterLimit=500;hb=this.options.borderWidth/2;if(this.options.borderWidth){ctx.strokeStyle=this.options.borderColor;ctx.lineWidth=this.options.borderWidth}else{stemLength=this.options.stemLength;stemBase=this.options.stemBase}stemBase==null&&(stemBase=0);drawLine=function(length,stem,first){first&&ctx.moveTo(Math.max(stemBase,_this.options.borderRadius,closeButtonInner[0])+1-hb,-hb);if(stem){ctx.lineTo(length/2-stemBase/2,-hb);ctx.lineTo(length/2,-stemLength-hb);return ctx.lineTo(length/2+stemBase/2,-hb)}};drawCorner=function(stem,closeButton,i){var angle1,angle2,innerWidth,offset;if(stem){ctx.lineTo(-stemBase+hb,0-hb);ctx.lineTo(stemLength+hb,-stemLength-hb);return ctx.lineTo(hb,stemBase-hb)}if(closeButton){offset=_this.options.closeButtonOffset;innerWidth=closeButtonInner[0];if(i%2!==0){offset=[offset[1],offset[0]];innerWidth=closeButtonInner[1]}angle1=Math.acos(offset[1]/_this.options.closeButtonRadius);angle2=Math.acos(offset[0]/_this.options.closeButtonRadius);ctx.lineTo(-innerWidth+hb,-hb);return ctx.arc(hb-offset[0],-hb+offset[1],_this.options.closeButtonRadius,-(Math.PI/2+angle1),angle2,!1)}ctx.lineTo(-_this.options.borderRadius+hb,-hb);return ctx.quadraticCurveTo(hb,-hb,hb,_this.options.borderRadius-hb)};ctx.translate(-canvasPosition[0],-canvasPosition[1]);ctx.save();(function(){var cornerStem,i,lineLength,lineStem,positionIdx,positionX,positionY,rotation,_i,_ref2,_results;_results=[];for(i=_i=0,_ref2=Opentip.positions.length/2;0<=_ref2?_i<_ref2:_i>_ref2;i=0<=_ref2?++_i:--_i){positionIdx=i*2;positionX=i===0||i===3?0:_this.dimensions.width;positionY=i<2?0:_this.dimensions.height;rotation=Math.PI/2*i;lineLength=i%2===0?_this.dimensions.width:_this.dimensions.height;lineStem=new Opentip.Joint(Opentip.positions[positionIdx]);cornerStem=new Opentip.Joint(Opentip.positions[positionIdx+1]);ctx.save();ctx.translate(positionX,positionY);ctx.rotate(rotation);drawLine(lineLength,lineStem.eql(_this.currentStem),i===0);ctx.translate(lineLength,0);drawCorner(cornerStem.eql(_this.currentStem),cornerStem.eql(closeButton),i);_results.push(ctx.restore())}return _results})();ctx.closePath();ctx.save();if(this.options.shadow){ctx.shadowColor=this.options.shadowColor;ctx.shadowBlur=this.options.shadowBlur;ctx.shadowOffsetX=this.options.shadowOffset[0];ctx.shadowOffsetY=this.options.shadowOffset[1]}ctx.fill();ctx.restore();this.options.borderWidth&&ctx.stroke();ctx.restore();if(closeButton)return function(){var crossCenter,crossHeight,crossWidth,hcs,linkCenter;crossWidth=crossHeight=_this.options.closeButtonRadius*2;if(closeButton.toString()==="top right"){linkCenter=[_this.dimensions.width-_this.options.closeButtonOffset[0],_this.options.closeButtonOffset[1]];crossCenter=[linkCenter[0]+hb,linkCenter[1]-hb]}else{linkCenter=[_this.options.closeButtonOffset[0],_this.options.closeButtonOffset[1]];crossCenter=[linkCenter[0]-hb,linkCenter[1]-hb]}ctx.translate(crossCenter[0],crossCenter[1]);hcs=_this.options.closeButtonCrossSize/2;ctx.save();ctx.beginPath();ctx.strokeStyle=_this.options.closeButtonCrossColor;ctx.lineWidth=_this.options.closeButtonCrossLineWidth;ctx.lineCap="round";ctx.moveTo(-hcs,-hcs);ctx.lineTo(hcs,hcs);ctx.stroke();ctx.beginPath();ctx.moveTo(hcs,-hcs);ctx.lineTo(-hcs,hcs);ctx.stroke();ctx.restore();return _this.adapter.css(_this.closeButtonElement,{left:""+(linkCenter[0]-hcs-_this.options.closeButtonLinkOverscan)+"px",top:""+(linkCenter[1]-hcs-_this.options.closeButtonLinkOverscan)+"px",width:""+(_this.options.closeButtonCrossSize+_this.options.closeButtonLinkOverscan*2)+"px",height:""+(_this.options.closeButtonCrossSize+_this.options.closeButtonLinkOverscan*2)+"px"})}()};Opentip.prototype._getPathStemMeasures=function(outerStemBase,outerStemLength,borderWidth){var angle,distanceBetweenTips,halfAngle,hb,rhombusSide,stemBase,stemLength;hb=borderWidth/2;halfAngle=Math.atan(outerStemBase/2/outerStemLength);angle=halfAngle*2;rhombusSide=hb/Math.sin(angle);distanceBetweenTips=2*rhombusSide*Math.cos(halfAngle);stemLength=hb+outerStemLength-distanceBetweenTips;if(stemLength<0)throw new Error("Sorry but your stemLength / stemBase ratio is strange.");stemBase=Math.tan(halfAngle)*stemLength*2;return{stemLength:stemLength,stemBase:stemBase}};Opentip.prototype._getColor=function(ctx,dimensions,color,horizontal){var colorStop,gradient,i,_i,_len;horizontal==null&&(horizontal=!1);if(typeof color=="string")return color;horizontal?gradient=ctx.createLinearGradient(0,0,dimensions.width,0):gradient=ctx.createLinearGradient(0,0,0,dimensions.height);for(i=_i=0,_len=color.length;_i<_len;i=++_i){colorStop=color[i];gradient.addColorStop(colorStop[0],colorStop[1])}return gradient};Opentip.prototype._searchAndActivateCloseButtons=function(){var element,_i,_len,_ref;_ref=this.adapter.findAll(this.container,"."+this["class"].close);for(_i=0,_len=_ref.length;_i<_len;_i++){element=_ref[_i];this.hideTriggers.push({element:this.adapter.wrap(element),event:"click"})}this.currentObservers.showing&&this._setupObservers("-showing","showing");if(this.currentObservers.visible)return this._setupObservers("-visible","visible")};Opentip.prototype._activateFirstInput=function(){var input;input=this.adapter.unwrap(this.adapter.find(this.container,"input, textarea"));return input!=null?typeof input.focus=="function"?input.focus():void 0:void 0};Opentip.prototype._followMousePosition=function(){if(!this.options.fixed)return this.adapter.observe(document.body,"mousemove",this.bound.reposition)};Opentip.prototype._stopFollowingMousePosition=function(){if(!this.options.fixed)return this.adapter.stopObserving(document.body,"mousemove",this.bound.reposition)};Opentip.prototype._clearShowTimeout=function(){return clearTimeout(this._showTimeoutId)};Opentip.prototype._clearHideTimeout=function(){return clearTimeout(this._hideTimeoutId)};Opentip.prototype._clearTimeouts=function(){clearTimeout(this._visibilityStateTimeoutId);this._clearShowTimeout();return this._clearHideTimeout()};Opentip.prototype._triggerElementExists=function(){var el;el=this.adapter.unwrap(this.triggerElement);while(el.parentNode){if(el.parentNode.tagName==="BODY")return!0;el=el.parentNode}return!1};Opentip.prototype._loadAjax=function(){var _this=this;if(this.loading)return;this.loaded=!1;this.loading=!0;this.adapter.addClass(this.container,this["class"].loading);this.debug("Loading content from "+this.options.ajax);return this.adapter.ajax({url:this.options.ajax,method:this.options.ajaxMethod,onSuccess:function(responseText){_this.debug("Loading successful.");_this.adapter.removeClass(_this.container,_this["class"].loading);return _this.setContent(responseText)},onError:function(error){var message;message="There was a problem downloading the content.";_this.debug(message,error);_this.setContent(message);return _this.adapter.addClass(_this.container,_this["class"].ajaxError)},onComplete:function(){_this.adapter.removeClass(_this.container,_this["class"].loading);_this.loading=!1;_this.loaded=!0;_this._searchAndActivateCloseButtons();_this._activateFirstInput();return _this.reposition()}})};Opentip.prototype._ensureTriggerElement=function(){if(!this._triggerElementExists()){this.deactivate();return this._stopEnsureTriggerElement()}};Opentip.prototype._ensureTriggerElementInterval=1e3;Opentip.prototype._startEnsureTriggerElement=function(){var _this=this;return this._ensureTriggerElementTimeoutId=setInterval(function(){return _this._ensureTriggerElement()},this._ensureTriggerElementInterval)};Opentip.prototype._stopEnsureTriggerElement=function(){return clearInterval(this._ensureTriggerElementTimeoutId)};return Opentip}();vendors=["khtml","ms","o","moz","webkit"];Opentip.prototype.setCss3Style=function(element,styles){var prop,value,vendor,vendorProp,_results;element=this.adapter.unwrap(element);_results=[];for(prop in styles){if(!__hasProp.call(styles,prop))continue;value=styles[prop];element.style[prop]!=null?_results.push(element.style[prop]=value):_results.push(function(){var _i,_len,_results1;_results1=[];for(_i=0,_len=vendors.length;_i<_len;_i++){vendor=vendors[_i];vendorProp=""+this.ucfirst(vendor)+this.ucfirst(prop);element.style[vendorProp]!=null?_results1.push(element.style[vendorProp]=value):_results1.push(void 0)}return _results1}.call(this))}return _results};Opentip.prototype.defer=function(func){return setTimeout(func,0)};Opentip.prototype.setTimeout=function(func,seconds){return setTimeout(func,seconds?seconds*1e3:0)};Opentip.prototype.ucfirst=function(string){return string==null?"":string.charAt(0).toUpperCase()+string.slice(1)};Opentip.prototype.dasherize=function(string){return string.replace(/([A-Z])/g,function(_,char){return"-"+char.toLowerCase()})};Opentip.Joint=function(){function Joint(pointerString){if(pointerString==null)return;pointerString instanceof Opentip.Joint&&(pointerString=pointerString.toString());this.set(pointerString);this}Joint.prototype.set=function(string){string=string.toLowerCase();this.setHorizontal(string);this.setVertical(string);return this};Joint.prototype.setHorizontal=function(string){var i,valid,_i,_j,_len,_len1,_results;valid=["left","center","right"];for(_i=0,_len=valid.length;_i<_len;_i++){i=valid[_i];~string.indexOf(i)&&(this.horizontal=i.toLowerCase())}this.horizontal==null&&(this.horizontal="center");_results=[];for(_j=0,_len1=valid.length;_j<_len1;_j++){i=valid[_j];_results.push(this[i]=this.horizontal===i?i:void 0)}return _results};Joint.prototype.setVertical=function(string){var i,valid,_i,_j,_len,_len1,_results;valid=["top","middle","bottom"];for(_i=0,_len=valid.length;_i<_len;_i++){i=valid[_i];~string.indexOf(i)&&(this.vertical=i.toLowerCase())}this.vertical==null&&(this.vertical="middle");_results=[];for(_j=0,_len1=valid.length;_j<_len1;_j++){i=valid[_j];_results.push(this[i]=this.vertical===i?i:void 0)}return _results};Joint.prototype.eql=function(pointer){return pointer!=null&&this.horizontal===pointer.horizontal&&this.vertical===pointer.vertical};Joint.prototype.flip=function(){var flippedIndex,positionIdx;positionIdx=Opentip.position[this.toString(!0)];flippedIndex=(positionIdx+4)%8;this.set(Opentip.positions[flippedIndex]);return this};Joint.prototype.toString=function(camelized){var horizontal,vertical;camelized==null&&(camelized=!1);vertical=this.vertical==="middle"?"":this.vertical;horizontal=this.horizontal==="center"?"":this.horizontal;vertical&&horizontal&&(camelized?horizontal=Opentip.prototype.ucfirst(horizontal):horizontal=" "+horizontal);return""+vertical+horizontal};return Joint}();Opentip.prototype._positionsEqual=function(posA,posB){return posA!=null&&posB!=null&&posA.left===posB.left&&posA.top===posB.top};Opentip.prototype._dimensionsEqual=function(dimA,dimB){return dimA!=null&&dimB!=null&&dimA.width===dimB.width&&dimA.height===dimB.height};Opentip.prototype.debug=function(){var args;args=1<=arguments.length?__slice.call(arguments,0):[];if(Opentip.debug&&(typeof console!=="undefined"&&console!==null?console.debug:void 0)!=null){args.unshift("#"+this.id+" |");return console.debug.apply(console,args)}};Opentip.findElements=function(){var adapter,content,element,optionName,optionValue,options,_i,_len,_ref,_results;adapter=Opentip.adapter;_ref=adapter.findAll(document.body,"[data-ot]");_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){element=_ref[_i];options={};content=adapter.data(element,"ot");if(content===""||content==="true"||content==="yes"){content=adapter.attr(element,"title");adapter.attr(element,"title","")}content=content||"";for(optionName in Opentip.styles.standard)if(optionValue=adapter.data(element,"ot"+Opentip.prototype.ucfirst(optionName))){if(optionValue==="yes"||optionValue==="true"||optionValue==="on")optionValue=!0;else if(optionValue==="no"||optionValue==="false"||optionValue==="off")optionValue=!1;options[optionName]=optionValue}_results.push(new Opentip(element,content,options))}return _results};Opentip.version="2.0.0-dev";Opentip.debug=!1;Opentip.lastId=0;Opentip.lastZIndex=100;Opentip.tips=[];Opentip._abortShowingGroup=function(){};Opentip._hideGroup=function(){};Opentip.adapters={};Opentip.adapter=null;firstAdapter=!0;Opentip.addAdapter=function(adapter){Opentip.adapters[adapter.name]=adapter;if(firstAdapter){Opentip.adapter=adapter;adapter.domReady(Opentip.findElements);return firstAdapter=!1}};Opentip.positions=["top","topRight","right","bottomRight","bottom","bottomLeft","left","topLeft"];Opentip.position={};_ref=Opentip.positions;for(i=_i=0,_len=_ref.length;_i<_len;i=++_i){position=_ref[i];Opentip.position[position]=i}Opentip.styles={standard:{title:void 0,escapeTitle:!0,escapeContent:!1,className:"standard",stem:!0,delay:null,hideDelay:.1,fixed:!1,showOn:"mouseover",hideTrigger:"trigger",hideTriggers:[],hideOn:null,offset:[0,0],containInViewport:!0,autoOffset:!0,showEffect:"appear",hideEffect:"fade",showEffectDuration:.3,hideEffectDuration:.2,stemLength:5,stemBase:8,tipJoint:"top left",target:null,targetJoint:null,ajax:!1,ajaxMethod:"GET",ajaxCache:!0,group:null,style:null,background:"#fff18f",backgroundGradientHorizontal:!1,closeButtonOffset:[5,5],closeButtonRadius:7,closeButtonCrossSize:4,closeButtonCrossColor:"#d2c35b",closeButtonCrossLineWidth:1.5,closeButtonLinkOverscan:6,borderRadius:5,borderWidth:1,borderColor:"#f2e37b",shadow:!0,shadowBlur:10,shadowOffset:[3,3],shadowColor:"rgba(0, 0, 0, 0.1)"},slick:{className:"slick",stem:!0},rounded:{className:"rounded",stem:!0},glass:{className:"glass",background:[[0,"rgba(252, 252, 252, 0.8)"],[.5,"rgba(255, 255, 255, 0.8)"],[.5,"rgba(250, 250, 250, 0.9)"],[1,"rgba(245, 245, 245, 0.9)"]],borderColor:"#eee",closeButtonCrossColor:"rgba(0, 0, 0, 0.2)",borderRadius:15,closeButtonRadius:10,closeButtonOffset:[8,8]},dark:{className:"dark",borderRadius:13,borderColor:"#444",closeButtonCrossColor:"rgba(240, 240, 240, 1)",shadowColor:"rgba(0, 0, 0, 0.3)",shadowOffset:[2,2],background:[[0,"rgba(30, 30, 30, 0.7)"],[.5,"rgba(30, 30, 30, 0.8)"],[.5,"rgba(10, 10, 10, 0.8)"],[1,"rgba(10, 10, 10, 0.9)"]]},alert:{className:"alert",borderRadius:1,borderColor:"#AE0D11",closeButtonCrossColor:"rgba(255, 255, 255, 1)",shadowColor:"rgba(0, 0, 0, 0.3)",shadowOffset:[2,2],background:[[0,"rgba(203, 15, 19, 0.7)"],[.5,"rgba(203, 15, 19, 0.8)"],[.5,"rgba(189, 14, 18, 0.8)"],[1,"rgba(179, 14, 17, 0.9)"]]}};Opentip.defaultStyle="standard";window.Opentip=Opentip;var __slice=[].slice,__hasProp={}.hasOwnProperty;(function($){var Adapter,bean,reqwest;bean=require("bean");reqwest=require("reqwest");$.ender({opentip:function(content,title,options){return new Opentip(this,content,title,options)}},!0);Adapter=function(){function Adapter(){}Adapter.prototype.name="ender";Adapter.prototype.domReady=function(callback){return $.domReady(callback)};Adapter.prototype.create=function(html){return $(html)};Adapter.prototype.wrap=function(element){element=$(element);if(element.length>1)throw new Error("Multiple elements provided.");return element};Adapter.prototype.unwrap=function(element){return $(element).get(0)};Adapter.prototype.tagName=function(element){return this.unwrap(element).tagName};Adapter.prototype.attr=function(){var args,element,_ref;element=arguments[0],args=2<=arguments.length?__slice.call(arguments,1):[];return(_ref=$(element)).attr.apply(_ref,args)};Adapter.prototype.data=function(){var args,element,_ref;element=arguments[0],args=2<=arguments.length?__slice.call(arguments,1):[];return(_ref=$(element)).data.apply(_ref,args)};Adapter.prototype.find=function(element,selector){return $(element).find(selector)};Adapter.prototype.findAll=function(){return this.find.apply(this,arguments)};Adapter.prototype.update=function(element,content,escape){element=$(element);return escape?element.text(content):element.html(content)};Adapter.prototype.append=function(element,child){return $(element).append(child)};Adapter.prototype.addClass=function(element,className){return $(element).addClass(className)};Adapter.prototype.removeClass=function(element,className){return $(element).removeClass(className)};Adapter.prototype.css=function(element,properties){return $(element).css(properties)};Adapter.prototype.dimensions=function(element){return $(element).dim()};Adapter.prototype.scrollOffset=function(){return[window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop]};Adapter.prototype.viewportDimensions=function(){return{width:document.documentElement.clientWidth,height:document.documentElement.clientHeight}};Adapter.prototype.mousePosition=function(e){var pos;pos={x:0,y:0};e==null&&(e=window.event);if(e==null)return;if(e.pageX||e.pageY){pos.x=e.pageX;pos.y=e.pageY}else if(e.clientX||e.clientY){pos.x=e.clientX+document.body.scrollLeft+document.documentElement.scrollLeft;pos.y=e.clientY+document.body.scrollTop+document.documentElement.scrollTop}return pos};Adapter.prototype.offset=function(element){var offset;offset=$(element).offset();return{top:offset.top,left:offset.left}};Adapter.prototype.observe=function(element,eventName,observer){return $(element).on(eventName,observer)};Adapter.prototype.stopObserving=function(element,eventName,observer){return $(element).unbind(eventName,observer)};Adapter.prototype.ajax=function(options){var _ref,_ref1;if(options.url==null)throw new Error("No url provided");return reqwest({url:options.url,type:"html",method:(_ref=(_ref1=options.method)!=null?_ref1.toUpperCase():void 0)!=null?_ref:"GET",error:function(resp){return typeof options.onError=="function"?options.onError("Server responded with status "+resp.status):void 0},success:function(resp){return typeof options.onSuccess=="function"?options.onSuccess(resp):void 0},complete:function(){return typeof options.onComplete=="function"?options.onComplete():void 0}})};Adapter.prototype.clone=function(object){var key,newObject,val;newObject={};for(key in object){if(!__hasProp.call(object,key))continue;val=object[key];newObject[key]=val}return newObject};Adapter.prototype.extend=function(){var key,source,sources,target,val,_i,_len;target=arguments[0],sources=2<=arguments.length?__slice.call(arguments,1):[];for(_i=0,_len=sources.length;_i<_len;_i++){source=sources[_i];for(key in source){if(!__hasProp.call(source,key))continue;val=source[key];target[key]=val}}return target};return Adapter}();return Opentip.addAdapter(new Adapter)})(ender);provide("opentip",module.exports)})()